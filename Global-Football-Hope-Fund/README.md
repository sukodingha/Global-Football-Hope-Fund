...
GFHF allows users to:

- create secure accounts and verify their email addresses
...
If you discover a security issue, please review [SECURITY.md](SECURITY.md) for the responsible reporting process.
